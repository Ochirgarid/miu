...
public class CDWindow extends JFrame {
    ...
    class ButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent evt){
            // JOptionPane.showMessageDialog(CDWindow.this, "Still need to check book rules!");
            RuleSet bookRules = RuleSetFactory.getRuleSet(CDWindow.this);
            try {
                bookRules.applyRules(CDWindow.this);
                JOptionPane.showMessageDialog(CDWindow.this, "All rules passed");
