...
public class ShoppingCartWindow extends Stage {
	...
	public ShoppingCartWindow() {
		...
		TableColumn<ShoppingCart, String> itemNameCol = new TableColumn<>(String.format("Item Name"));
		itemNameCol.setMinWidth(200);
		itemNameCol.setCellValueFactory(new PropertyValueFactory<ShoppingCart, String>("itemName"));
		itemNameCol.setCellFactory(TextFieldTableCell.forTableColumn());
		itemNameCol.setEditable(false);

		TableColumn<ShoppingCart, String> quantityCol = new TableColumn<>("Quantity");
		quantityCol.setMinWidth(80);
		quantityCol.setCellValueFactory(new PropertyValueFactory<ShoppingCart, String>("quantity"));
		quantityCol.setCellFactory(TextFieldTableCell.forTableColumn());

		TableColumn<ShoppingCart, String> unitPriceCol = new TableColumn<>(String.format("Unit Price"));
		unitPriceCol.setMinWidth(80);
		unitPriceCol.setEditable(false);
		unitPriceCol.setCellValueFactory(new PropertyValueFactory<ShoppingCart, String>("price"));
		unitPriceCol.setCellFactory(TextFieldTableCell.forTableColumn());

		TableColumn<ShoppingCart, String> totalPriceCol = new TableColumn<>(String.format("Total Price"));
		totalPriceCol.setMinWidth(80);
		totalPriceCol.setEditable(false);
		totalPriceCol.setCellValueFactory(new PropertyValueFactory<ShoppingCart, String>("totalPrice"));
	...
	public void setShoppingCartWindowData(ProductDetailsWindow prodDetails, Product selectedProd) {
